...
import snack_pb2 as snack__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in snack_pb2_grpc.py depends on'
...
def add_SnakeGameServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'snack.SnakeGame', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('snack.SnakeGame', rpc_method_handlers)
